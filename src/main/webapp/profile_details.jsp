	...
	<div>
	    <div class="row">
	      ...
	      <div class="rightcolumn">
	          <img src="img/details.svg" class="img-fluid" alt="Signup image" width="100%" height="80%" onContextMenu="return false;">
	      </div>
	    </div>
	    <button onclick="newUpdateProfileOpen()">Update</button>
	    
	    <!-- Update Logic -->
	    <div id="up" class="modal">
			     <div id="upi" class="alert info"><span class="closebtn">&times;</span></div>
			     <div class="modal-content animate">
			          <div class="container" style="background-color:blue">
			                <h1 style="text-align: center;" class="p1">User Profile Update</h1>
			          </div>
			          <div class="container" style="pointer-events: all">
			            	<span onclick="newUpdateProfileClose()" class="close" title="Close Modal" style="pointer-events: all;">&times;</span>
			                <h1 style="text-align: center;">Are you Sure to Update</h1>
			                <hr size="3" width="90%" color="blue">
			                <div class="leftcolumn">
							      <fieldset>
							        <legend>Username</legend>
							            <input type="text" id="a1" placeholder="Username" disabled/>
							      </fieldset>
							      <br/>
							      <fieldset>
							        <legend>Email</legend>
							            <input type="text" id="a2" placeholder="Email" disabled/>
							      </fieldset>
							      <br/>
							      <fieldset>
			    				    <legend>Name</legend>
							            <input type="text" id="a3" placeholder="Name"/>
							      </fieldset>
							      <fieldset>
			   				       <legend>Year</legend>
							          <!-- <input type="text" id="t4" placeholder="Year"/>-->
							          <select name="year" id="a4" required> 
							       ...
							       <legend>State</legend>
							           ...
							           <select name="state" id="a6" required> 
						                    <option>Select one</option> 
							       ...
							       <fieldset>
							       <legend>Phone</legend>
							          <input type="text" id="a7" placeholder="Phone Number"/>
							       </fieldset>
							       <br/>
							       <fieldset>
							       <legend>Branch</legend>
								       	<!-- <input type="text" id="t8" placeholder="Branch"/>-->
								       	<select name="branch" id="a8" required> 
						                      <option>Select One</option> 
